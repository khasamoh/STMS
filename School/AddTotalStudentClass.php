<?php
    ...
    $call = new STMSchool();
    if(isset($_POST['AddTotalStu'])){
           $call->AddTotalStudent();
        }
$className = $_GET['Nm'];
?>
<!DOCTYPE html>
...
<body>
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" method="post" action="AddTotalStudentClass.php">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="hidden" class="form-control"<?php echo"value='".$_SESSION['SchlID']."'"?> name="SchlID" required>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" name="AddTotalStu" class="btn btn-success"><i class="ti-plus"></i> Add</button>
    ...
    ?>
    <script>
       Swal.fire({toast:true, type:"success", title:"Total Student Added", animation:true, showConfirmButton: false, position:"top", timer:3000, timerProgressBar:true,});
    </script>
    <?php
    ...
    ?>
    <script>
        Swal.fire({toast:true, type:"info", title:"Sorry! This Class Already Added", animation:true, showConfirmButton: false, position:"top", timer:3000, timerProgressBar:true,});
    </script>
        <?php
        }
